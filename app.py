...
COURSES = {
    ...
    "일본어": {"sem":"2-1","grp":"택1","cr":3,"eval":"5등급 상대평가","desc":"일본어의 기초 발음, 문법, 회화를 학습하여 기본적인 의사소통 능력을 기릅니다.","tracks":["어문계","국제외교","상경계"],"kw":["일본어","일본","통역","번역","무역","관광","비즈니스"],
        "aff":{"국어":0.2,"수학":0.0,"영어":0.2,"과학":0.0,"사회":0.4},"diff":3,"mem":0.5,"und":0.3,"pra":0.2,"wl":3,"gc":"보통","rmg":{},
    ...
    "일본어 회화": {"sem":"2-2","grp":"택1-가","cr":3,"eval":"5등급 상대평가","desc":"일본어 듣기·말하기 능력을 집중적으로 훈련하여 실용적 회화 능력을 기릅니다.","tracks":["어문계","국제외교","상경계"],"kw":["일본어","회화","일본","통역","무역","관광"],
        "aff":{"국어":0.2,"수학":0.0,"영어":0.2,"과학":0.0,"사회":0.3},"diff":3,"mem":0.4,"und":0.3,"pra":0.3,"wl":3,"gc":"보통","rmg":{},
    ...
    "세포와 물질대사": {"sem":"2-2","grp":"택3","cr":3,"eval":"5등급 상대평가","desc":"세포의 구조와 기능, 물질대사(효소, 광합성, 세포호흡) 등을 심화 학습합니다.","tracks":["의약계","자연과학","보건간호"],"kw":["세포","물질대사","효소","광합성","세포호흡","생명과학","의대","약대","바이오","간호"],
        "aff":{"국어":0.0,"수학":0.3,"영어":0.1,"과학":0.9,"사회":0.0},"diff":4,"mem":0.4,"und":0.5,"pra":0.1,"wl":4,"gc":"높음","rmg":{"과학":2},
        "univ_note":"서울대 의대 권장 필수 과목! '생물의 유전'과 함께 의약계 과학 진로선택 3과목 요건의 핵심이에요."},
...
TRACK_UNIV_GUIDE = {
    ...
    "의약계 (의대·치대·한의대·약대·수의대)": {
        ...
        "third": "2학년에서 <b>기하, 생명과학, 화학 → 미적분Ⅱ, 세포와 물질대사, 물질과 에너지</b>를 반드시 이수하세요. 이게 3학년 '고급 생명과학/화학'의 기초예요.",
    },
    "보건·간호": {
        "icon": "💊",
        "prereq": "간호학과 등은 <b>생명과학·화학</b> 관련 진로선택 3과목 이상 이수를 권장하는 대학이 많아요.",
        "third": "2학년에서 <b>생명과학 + 화학 → 세포와 물질대사 + 물질과 에너지</b>를 이수하면 과학 이수 요건을 채울 수 있어요.",
    },
    ...
    "환경·도시·건축": {
        ...
        "third": "2학년에서 <b>기하 + 물리학/화학 → 미적분Ⅱ + 역학과 에너지 + 물질과 에너지</b>를 이수하세요. 환경공학은 화학이, 건설환경은 지구과학이 중요하니 진로에 따라 과학 선택을 조절하세요.",
    },
    "미디어·언론·광고": {
        "icon": "📺",
...
TRACK_COMBOS = {
    ...
    "의약계 (의대·치대·한의대·약대·수의대)": {
        ...
        "2학기": {"택1-가": "인공지능 수학", "택3": ["세포와 물질대사", "물질과 에너지", "역학과 에너지"], "택1-나": "미적분Ⅱ"},
    },
    "보건·간호": {
        "desc": "간호학, 보건학, 물리치료, 임상병리 등 보건의료 계열",
        "1학기": {"택1": "기하", "택3": ["생명과학", "화학", "윤리와 사상"]},
        "2학기": {"택1-가": "인공지능 수학", "택3": ["세포와 물질대사", "물질과 에너지", "현대사회와 윤리"], "택1-나": "미적분Ⅱ"},
    },
    "자연과학 (수학·물리·화학·생명·지구과학)": {
        "desc": "기초과학 연구, 수학과, 물리학과, 화학과, 생명과학, 지구과학 등",
        "1학기": {"택1": "기하", "택3": ["물리학", "화학", "생명과학"]},
        "2학기": {"택1-가": "인공지능 수학", "택3": ["역학과 에너지", "물질과 에너지", "세포와 물질대사"], "택1-나": "미적분Ⅱ"},
    },
    "인문·사회 (인문학·사회학·심리학)": {
